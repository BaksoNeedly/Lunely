...
const headerElement = document.querySelector<HTMLElement>('[data-header]');
const bodyElement = document.querySelector<HTMLElement>('[data-body]');
const footerElement = document.querySelector<HTMLElement>('[data-footer]');
